...
function gravity_enqueue_styles_scripts() {
	...
	wp_enqueue_style( 'gf-custom-general', get_stylesheet_directory_uri() . '/gravity/inc/assets/gf-custom-general.css', array(), '1.3.0', 'all' );
	...
	*/
	...
	wp_register_script( 'gf-custom-script', get_stylesheet_directory_uri() . '/gravity/inc/js/gf-custom-script.js', array( 'jquery' ), '1.3.2', true );
